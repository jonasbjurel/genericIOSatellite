...
F 3 "https://toshiba.semicon-storage.com/info/docget.jsp?did=12884&prodName=TLP291" H 12450 1400 50  0001 L CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 14350 1800 2    118  Input ~ 0
ACT(GND)-0
$Comp
L Device:R R?
U 1 1 65589912
...
F 0 "R?" V 12057 1300 50  0000 C CNN
F 1 "R" V 11966 1300 50  0000 C CNN
F 2 "" V 11780 1300 50  0001 C CNN
...
Text HLabel 14350 2100 2    118  Output ~ 0
SERVO-0
Text HLabel 14350 1000 2    118  Input ~ 0
ACT(+)-0
$Comp
L Isolator:TLP291 U?
U 1 1 6558993D
...
F 3 "https://www.diodes.com/assets/Datasheets/ds16008.pdf" H 13750 4550 50  0001 C CNN
	...
	0    1    1    0   
$EndComp
Text HLabel 14350 4700 2    118  Input ~ 0
ACT_GND-1
$Comp
L Device:R R?
U 1 1 65589959
...
ACTOUT-1
Text HLabel 14350 3100 2    118  Input ~ 0
ACT_IN-1
$Comp
L Isolator:TLP291 U?
U 1 1 65589984
...
F 3 "https://www.diodes.com/assets/Datasheets/ds16008.pdf" H 13750 6700 50  0001 C CNN
	...
	0    1    1    0   
$EndComp
Text HLabel 14350 6850 2    118  Input ~ 0
ACT_GND-2
$Comp
L Device:R R?
U 1 1 655899A0
...
ACTOUT-2
Text HLabel 14400 5250 2    118  Input ~ 0
ACT_IN-2
$Comp
L Isolator:TLP291 U?
U 1 1 655899CB
...
F 3 "https://www.diodes.com/assets/Datasheets/ds16008.pdf" H 13750 8800 50  0001 C CNN
	...
	0    1    1    0   
$EndComp
Text HLabel 14350 8950 2    118  Input ~ 0
ACT_GND-3
$Comp
L Device:R R?
U 1 1 655899E7
...
ACTOUT-3
Text HLabel 14350 7350 2    118  Input ~ 0
ACT_IN-3
$Comp
L Isolator:TLP291 U?
U 1 1 65589A12
...
POW6V-
Text GLabel 11250 1750 0    118  Input ~ 0
6V_INT
...
3V3
Text GLabel 3700 4700 2    118  Output ~ 0
GND
Wire Wire Line
	14350 3100 13750 3100
Connection ~ 13750 3100
Wire Wire Line
	14350 4700 13750 4700
Wire Wire Line
	14400 5250 13750 5250
Connection ~ 13750 5250
Wire Wire Line
	14350 6850 13750 6850
Wire Wire Line
	14350 7350 13750 7350
Connection ~ 13750 7350
Wire Wire Line
	13750 8950 14350 8950
$Comp
L Transistor_FET:BUZ11 Q?
U 1 1 66009987
P 13650 1500
F 0 "Q?" H 13855 1546 50  0000 L CNN
F 1 "BUZ11" H 13855 1455 50  0000 L CNN
F 2 "Package_TO_SOT_THT:TO-220-3_Vertical" H 13900 1425 50  0001 L CIN
F 3 "https://media.digikey.com/pdf/Data%20Sheets/Fairchild%20PDFs/BUZ11.pdf" H 13650 1500 50  0001 L CNN
	1    13650 1500
	1    0    0    -1  
$EndComp
Text HLabel 14350 1300 2    118  Input ~ 0
ACT(-)-0
$Comp
L Diode:US1M D?
U 1 1 66095CCA
P 13750 1150
AR Path="/66095CCA" Ref="D?"  Part="1" 
AR Path="/653FA36F/66095CCA" Ref="D?"  Part="1" 
F 0 "D?" V 13704 1230 50  0000 L CNN
F 1 "US1M" V 13795 1230 50  0000 L CNN
F 2 "Diode_SMD:D_SMA" H 13750 975 50  0001 C CNN
F 3 "https://www.diodes.com/assets/Datasheets/ds16008.pdf" H 13750 1150 50  0001 C CNN
	1    13750 1150
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 662B79C6
P 13300 1650
AR Path="/662B79C6" Ref="R?"  Part="1" 
AR Path="/653FA36F/662B79C6" Ref="R?"  Part="1" 
F 0 "R?" V 13507 1650 50  0000 C CNN
F 1 "R" V 13416 1650 50  0000 C CNN
F 2 "" V 13230 1650 50  0001 C CNN
...
Wire Wire Line
	13300 1300 13300 1000
Wire Wire Line
	13300 1000 13750 1000
Connection ~ 13750 1000
Text Notes 13150 2750 2    79   ~ 0
MAX 60 mA
$Comp
L Transistor_FET:BUZ11 Q?
U 1 1 6652A7E8
P 11700 2300
F 0 "Q?" H 11905 2346 50  0000 L CNN
F 1 "BUZ11" H 11905 2255 50  0000 L CNN
F 2 "Package_TO_SOT_THT:TO-220-3_Vertical" H 11950 2225 50  0001 L CIN
F 3 "https://media.digikey.com/pdf/Data%20Sheets/Fairchild%20PDFs/BUZ11.pdf" H 11700 2300 50  0001 L CNN
	1    11700 2300
	1    0    0    -1  
$EndComp
Connection ~ 11350 1500
Wire Wire Line
	11350 1500 12150 1500
$Comp
L Device:R R?
U 1 1 663B52EC
P 14150 2100
AR Path="/663B52EC" Ref="R?"  Part="1" 
AR Path="/653FA36F/663B52EC" Ref="R?"  Part="1" 
F 0 "R?" V 14357 2100 50  0000 C CNN
F 1 "R" V 14266 2100 50  0000 C CNN
...
Wire Wire Line
	11350 1500 11350 2500
Wire Wire Line
	11250 1300 11500 1300
Wire Wire Line
	11500 2300 11500 1300
Connection ~ 11500 1300
$Comp
L Device:R R?
U 1 1 668BC3F7
P 11800 1900
AR Path="/668BC3F7" Ref="R?"  Part="1" 
AR Path="/653FA36F/668BC3F7" Ref="R?"  Part="1" 
F 0 "R?" V 12007 1900 50  0000 C CNN
F 1 "R" V 11916 1900 50  0000 C CNN
F 2 "" V 11730 1900 50  0001 C CNN
...
Wire Wire Line
	11250 1750 11800 1750
Wire Wire Line
	11800 2100 14000 2100
...
U 1 1 66C290E8
P 14050 1300
AR Path="/66C290E8" Ref="F?"  Part="1" 
AR Path="/653FA36F/66C290E8" Ref="F?"  Part="1" 
F 0 "F?" H 14138 1346 50  0000 L CNN
F 1 "Polyfuse" H 14138 1255 50  0000 L CNN
F 2 "" H 14100 1100 50  0001 L CNN
